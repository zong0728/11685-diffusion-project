...
#SBATCH --output=logs/T1_ddim30_%j.out
#SBATCH --error=logs/T1_ddim30_%j.err
...
run_eval --ckpt "$CKPT" --variance_type learned_range \
         ...
         --run_name sweep_T1_ddim30 2>&1 | tee eval_results/sweep_T1_ddim30.txt
