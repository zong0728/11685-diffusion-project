...
#SBATCH --output=logs/T1_s777_%j.out
#SBATCH --error=logs/T1_s777_%j.err
...
run_eval --ckpt "$CKPT" --variance_type learned_range \
         ...
         --seed 777 \
         --run_name sweep_T1_best_seed777 2>&1 | tee eval_results/sweep_T1_best_seed777.txt
