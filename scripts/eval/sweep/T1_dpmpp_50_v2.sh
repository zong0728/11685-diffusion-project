...
#SBATCH --output=logs/T1_dpmpp50v2_%j.out
#SBATCH --error=logs/T1_dpmpp50v2_%j.err
...
run_eval --ckpt "$CKPT" \
         ...
         --run_name sweep_T1_dpmpp50_v2 2>&1 | tee eval_results/sweep_T1_dpmpp50_v2.txt
