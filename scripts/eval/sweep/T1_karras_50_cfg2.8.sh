...
#SBATCH --output=logs/T1_k50c28_%j.out
#SBATCH --error=logs/T1_k50c28_%j.err
...
run_eval --ckpt "$CKPT" --variance_type learned_range \
         ...
         --ddim_karras True \
         --run_name sweep_T1_karras50_cfg2.8 2>&1 | tee eval_results/sweep_T1_karras50_cfg2.8.txt
