...
# Overnight Run E: Disable CFG (unconditional training)
# Tests how much CFG contributes vs a plain class-conditional setup.
...
python train.py \
    ...
    --latent_ddpm True --use_cfg False --use_ddim True \
