...
#SBATCH --output=logs/T1_kar100_%j.out
#SBATCH --error=logs/T1_kar100_%j.err
...
run_eval --ckpt "$CKPT" --variance_type learned_range \
         ...
         --ddim_karras True \
         --run_name sweep_T1_karras100 2>&1 | tee eval_results/sweep_T1_karras100.txt
