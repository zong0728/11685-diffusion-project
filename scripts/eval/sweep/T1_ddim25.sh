...
#SBATCH --output=logs/T1_ddim25_%j.out
#SBATCH --error=logs/T1_ddim25_%j.err
...
run_eval --ckpt "$CKPT" --variance_type learned_range \
         ...
         --run_name sweep_T1_ddim25 2>&1 | tee eval_results/sweep_T1_ddim25.txt
