...
#SBATCH --output=logs/T1_cfg35_%j.out
#SBATCH --error=logs/T1_cfg35_%j.err
...
run_eval --ckpt "$CKPT" --variance_type learned_range \
         ...
         --run_name sweep_T1_cfg3.5 2>&1 | tee eval_results/sweep_T1_cfg3.5.txt
